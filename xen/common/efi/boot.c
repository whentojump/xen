...
static void __init efi_exit_boot(EFI_HANDLE ImageHandle, EFI_SYSTEM_TABLE *SystemTable)
{
     ...
     */
    efi_arch_post_exit_boot(); /* Checks CurrentEL, doesn't return */
                                      ...
                                      EFI_SYSTEM_TABLE *SystemTable)
{
    ...
    /*
     * efi_exit_boot() now calls efi_arch_post_exit_boot() internally,
     * which never returns (it either boots Xen or halts with diagnostic).
     * Mark this as unreachable for the compiler.
     */
    unreachable();
}
